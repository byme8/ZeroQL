...
public static class GraphQLGenerator
{
    ...
    public static string ToCSharp(string graphql, GraphQlGeneratorOptions options)
    {
        ...
        var descendantNodes = ParseSyntaxTree(namespaceDeclaration).GetRoot();
        var fixedNodes = FixTypeNamingWhenNameEqualsMemberName(descendantNodes);

        var formattedRoot = Formatter.Format(fixedNodes, new AdhocWorkspace());
