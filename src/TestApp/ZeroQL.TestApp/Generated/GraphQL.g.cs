// 99b5ff50d1a5f59e95711614f6c05f18
...
namespace GraphQL.TestServer
{
    ...
    {
        private static IZeroQLSerializer DefaulSerializer { get; } = JsonConvertersInitializers.CreateSerializer();
        
        public TestServerClient(
            global::System.Net.Http.HttpClient client, 
            IZeroQLSerializer? options = null,
            PipelineType pipelineType = PipelineType.Full) 
            : base(client, options ?? DefaulSerializer, pipelineType)
        {
        }
    ...
    {
        public static IZeroQLSerializer CreateSerializer()
        {
            var options = ZeroQLJsonOptions.Create();
            var converters = new Dictionary<Type, JsonConverter>
            {
                {
                    typeof(global::GraphQL.TestServer.ZonedDateTime),
                    new ZeroQLScalarJsonConverter<global::GraphQL.TestServer.ZonedDateTime>()
                },
                {
                    typeof(IEntity),
                    new ZeroQLIEntityConverter(options)
                }
            };
