// 4578c2022b146fbdf6324809434f14fa
...
namespace GraphQL.TestServer
{
    ...
    public class Query : global::ZeroQL.Internal.IQuery
    {
        ...
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never), JsonPropertyName("UserGLID")]
        public User __UserGLID { get; set; }
        ...
        [ZeroQL.GraphQLFieldSelector]
        public T? UserGLID<T>(ID id, Func<User?, T> selector)
        {
            return __UserGLID != default ? selector(__UserGLID) : default;
        }
